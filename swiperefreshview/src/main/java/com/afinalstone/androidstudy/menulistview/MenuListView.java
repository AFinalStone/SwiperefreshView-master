...
public class MenuListView extends ListView {
	...
	public void setAdapter(ListAdapter adapter) {
		super.setAdapter(new MenuAdapter(getContext(), adapter) {
			@Override
			...
			@Override
			public void onItemClick(MenuView view, Menu menu,
									int index) {
	...
	public static interface OnMenuItemClickListener {
		void onMenuItemClick(int position, Menu menu, int index);
	}
