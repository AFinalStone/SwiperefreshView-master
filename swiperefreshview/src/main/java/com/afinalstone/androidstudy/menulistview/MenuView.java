...
public class MenuView extends LinearLayout implements OnClickListener {
	...
	public MenuView(Menu menu, MenuListView listView) {
	...
	private ImageView createIcon(MenuItem item) {
		ImageView iv = new ImageView(getContext());
		iv.setImageDrawable(item.getIcon());
		return iv;
	}

	private TextView createTitle(MenuItem item) {
	...
	public void setLayout(MenuLayout mLayout) {
