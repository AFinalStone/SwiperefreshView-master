...
public class ShapedImageView extends ImageView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, com.afinalstone.androidstudy.R.styleable.ShapedImageView);
            mShapeMode = a.getInt(com.afinalstone.androidstudy.R.styleable.ShapedImageView_shape_mode, 0);
            mRadius = a.getDimension(com.afinalstone.androidstudy.R.styleable.ShapedImageView_round_radius, 0);
            a.recycle();
        }
        mPaint = new Paint();
